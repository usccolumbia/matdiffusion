...
for lst in full_lst:
    ...
    out_dir = 'generation_outputs_e2e'
    ...
    # print('number_samples: ', num_samples)

    COMMAND = f'python scripts/{mode}_sample.py ' \
    f'--model_path {tgt} --batch_size 100 --num_samples {num_samples} --top_p {top_p} ' \
    f'--out_dir {out_dir} '
    print(COMMAND)
    # os.system(COMMAND)
