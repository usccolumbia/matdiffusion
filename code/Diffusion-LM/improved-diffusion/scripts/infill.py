    ...
    if args.modality in ['synth', 'pos']:
        ...
        if args.eval_task_ == 'infill':
            ...
            if args.eval_task_ == 'control_attribute':##
                print("^"*20)
                # print()
                model_control = Classifier_GPT2.from_pretrained('/home/rongzhid/Diffusion-LM-mp/classifier_models/e2e-tgt_e=6_b=10_m=gpt2_wikitext-103-raw-v1_101_wp_None').cuda()
                
                # exit()
                control_label_lst = []
                with open('/home/rongzhid/Diffusion-LM-mp/improved-diffusion/control_gen/target_attribute.json', 'r') as controlf:
            ...
            if args.eval_task_ == 'control_attribute_compose':
                ...
                model_control = Classifier_Tree.from_pretrained(
                    '/home/rongzhid/Diffusion-LM-mp/classifier_models_e2e/e2e-tgt_e=6_b=10_m=bert-base-uncased_wikitext-103-raw-v1_101_wp_None').cuda()
                ...
                ###############
                control_label_lst = []
                with open('home/rongzhid/Diffusion-LM-mp/improved-diffusion/control_gen/target_tree.json',
                          'r') as controlf:
                    for line in controlf:
                        control_label_lst.append(json.loads(line))
